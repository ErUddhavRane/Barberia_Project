                ...
                <div className="row justify-content-center">
                    <div className="card p-0 overflow-hidden h-100 shadow me-5">
                        <div className="card-body">
                            ...
                            <button className="btn btn-success" onClick={() => handleClick(data.haircut)}>Add to Cart</button>
                        </div>
                    </div>
                    ...
                    <div className="card p-0 overflow-hidden h-100 shadow me-3 mb-3">
                        <div className="card-body">
                            ...
                            <button className="btn btn-success" onClick={() => handleClick(data.beardshape)}>Add to Cart</button>
                        </div>
                    </div>
                    <div className="card p-0 overflow-hidden h-100 shadow me-3 mb-3">
                        <div className="card-body">
                            ...
                            <button className="btn btn-success" onClick={() => handleClick(data.bodymassage)}>Add to Cart</button>
                        </div>
                    </div>
                    <div className="card p-0 overflow-hidden h-100 shadow me-3 mb-3">
                        <div className="card-body">
                            ...
                            <button className="btn btn-success" onClick={() => handleClick(data.haircolour)}>Add to Cart</button>
                        </div>
                    </div>
                    <div className="card p-0 overflow-hidden h-100 shadow me-5 mb-5">
                        <div className="card-body">
                            ...
                            <button className="btn btn-success" onClick={() => handleClick(data.facial)}>Add to Cart</button>
                        </div>
                    </div>
                    <div className="card p-0 overflow-hidden h-100 shadow me-5 mb-5">
                        <div className="card-body">
                            ...
                            <button className="btn btn-success" onClick={() => handleClick(data.cleanshave)}>Add to Cart</button>
                        </div>
                    </div>
                    <div className="card p-0 overflow-hidden h-100 shadow me-5 mb-5">
                        <div className="card-body">
                            ...
                            <button className="btn btn-success" onClick={() => handleClick(data.facescrub)}>Add to Cart</button>
                        </div>
                    </div>
                    <div className="card p-0 overflow-hidden h-100 shadow me-5 mb-5">
                        <div className="card-body">
                            ...
                            <button className="btn btn-success" onClick={() => handleClick(data.headmassage)}>Add to Cart</button>
                        </div>
                    </div>
                    <div className="card p-0 overflow-hidden h-100 shadow me-5 mb-5">
                        <div className="card-body">
                            ...
                            <button className="btn btn-success" onClick={() => handleClick(data.trimbeard)}>Add to Cart</button>
                        </div>
                    </div>
                </div>
            </div>
